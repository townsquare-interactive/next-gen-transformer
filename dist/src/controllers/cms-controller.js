...
const transformPagesData = (pageData, sitePageData, themeStyles, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (const [key, value] of Object.entries(pageData)) {
            ...
            if (value.data.modules) {
                ...
                value.data = Object.assign(Object.assign({ id: pageId, title: pageTitle, slug: pageSlug, pageType: pageType, url: url }, value.data), {
...
const createPageScss = (pageData, pageSlug, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
        let pageCss
...
const deletePages = (pages, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
const updatePageList = (page, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
const addPagesToList = (pageListFile, page, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
const addNewPageToNav = (pageData, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
const createOrEditLayout = (file, basePath, themeStyles) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (moduleList[i]) {
            ...
            for (const [key, value] of Object.entries(moduleList[i])) {
                ...
                for (let i = 0; i < value.items.length; i++) {
                    ...
                    value.items[i] = Object.assign(Object.assign({}, value.items[i]), {
                ...
                const modData = Object.assign(Object.assign({}, newModule), {
                    modId: key,
                    modCount: modCount,
                    columnLocation: i,
...
const createGlobalStylesheet = (themeStyles, fonts, code, currentPageList, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
const getAllCssPages = (currentPageList, basePath) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const allPageCss = []
